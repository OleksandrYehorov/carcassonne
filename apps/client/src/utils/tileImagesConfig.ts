...
export const TILE_IMAGES: Record<TileType, string> = {
  START: tile4Image,
  MONASTERY_ROAD: tile1Image,
  MONASTERY: tile2Image,
  CITY_FULL: tile3Image,
  CITY_ONE_ROAD: tile4Image,
  CITY_ONE: tile5Image,
  CITY_TWO_FORTIFIED: tile6Image,
  CITY_TWO: tile7Image,
  CITY_TWO_OPPOSITE: tile8Image,
  CITY_TWO_ADJACENT: tile9Image,
  CITY_ONE_ROAD_BENT_RIGHT: tile10Image,
  CITY_ONE_ROAD_BENT_LEFT: tile11Image,
  CITY_ONE_CROSSROAD: tile12Image,
  CITY_CORNER_FORTIFIED: tile13Image,
  CITY_CORNER: tile14Image,
  CITY_CORNER_ROAD_FORTIFIED: tile15Image,
  CITY_CORNER_ROAD: tile16Image,
  CITY_THREE_FORTIFIED: tile17Image,
  CITY_THREE: tile18Image,
  CITY_THREE_ROAD_FORTIFIED: tile19Image,
  CITY_THREE_ROAD: tile20Image,
  ROAD_STRAIGHT: tile21Image,
  ROAD_CURVED: tile22Image,
  ROAD_THREE_CROSSROAD: tile23Image,
  ROAD_FOUR_CROSSROAD: tile24Image,
};
